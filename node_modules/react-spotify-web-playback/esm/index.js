...
var SpotifyWebPlayer = /** @class */ (function (_super) {
    ...
    function SpotifyWebPlayer(props) {
        ...
        Object.defineProperty(_this, "toggleOffset", {
            ...
            writable: true,
            value: function () { return __awaiter(_this, void 0, void 0, function () {
                var currentDeviceId, _a, offset, token, uris;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            currentDeviceId = this.state.currentDeviceId;
                            _a = this.props, offset = _a.offset, token = _a.token, uris = _a.uris;
                            if (!(typeof offset === 'number' && Array.isArray(uris))) return [3 /*break*/, 2];
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 8:
                            ...
                            return [4 /*yield*/, this.togglePlay(!track.id || changedURIs)];
                        case 9:
                            _c.sent();
                            _c.label = 10;
                        case 10:
