...
private
  ...
  def song_params
    params.permit(:image_url, :preview_url, :playlist_id, :name, :preview_url, :spotify_album_id, :spotify_playlist_id, :spotify_artist_id, :featured_artist, :release_date, :genre, :spotify_id)
  end
